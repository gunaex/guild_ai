...
// Public builds must not embed OAuth app credentials. Configure these through
// OAUTH_GITHUB_CLIENT_ID, OAUTH_GOOGLE_CLIENT_ID, and OAUTH_GOOGLE_CLIENT_SECRET.
