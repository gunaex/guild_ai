...
- LAN/internet hardened deployment: 75%
...
- API: 65 test files passed, 260 tests passed.
...
7. Use the deployment readiness panel before LAN access, then add one-command production service install/backup automation.
